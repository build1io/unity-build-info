...
{
    public sealed class BuildInfoWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Label(BuildInfoProcessor.BuildInfo.BuildNumber.ToString(), style);
            ...
            var isSandboxBuild = BuildInfoProcessor.BuildInfo.IsSandboxBuild;
            var isSandboxBuildNew = GUILayout.Toggle(isSandboxBuild, " Is Sandbox Build");
            if (isSandboxBuild != isSandboxBuildNew)
                BuildInfoProcessor.SetIsSandboxBuild(isSandboxBuildNew);
        ...
        public static void Open()
        {
            ...
            var window = GetWindow<BuildInfoWindow>(false, "Build Info", true);
